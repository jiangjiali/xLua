...
client:start(function(event)
        ...
        if t == yasio.YEK_PACKET then
            --[[
                param: buffer_type [optional], default is: yasio.BUFFER_DEFAULT
                   yasio.BUFFER_DEFAULT: take packet as native yasio::ibstream
                   yasio.BUFFER_RAW: take packet as lua string
                   yasio.BUFFER_FAST: take packet as native yasio::fast_ibstream
            ]]
            local ibs = event:packet(yasio.BUFFER_DEFAULT)
